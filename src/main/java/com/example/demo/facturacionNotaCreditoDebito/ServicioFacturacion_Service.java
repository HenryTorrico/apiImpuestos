 ...
 * 
 */
@WebServiceClient(name = "ServicioFacturacion", targetNamespace = "https://siat.impuestos.gob.bo/ServicioFacturacionNotaCreditoDebito", wsdlLocation = "https://pilotosiatservicios.impuestos.gob.bo/v1/ServicioFacturacionNotaCreditoDebito?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICIOFACTURACION_QNAME = new QName("https://siat.impuestos.gob.bo/ServicioFacturacionNotaCreditoDebito", "ServicioFacturacion");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://pilotosiatservicios.impuestos.gob.bo/v1/ServicioFacturacionNotaCreditoDebito?wsdl");
    ...
    public ServicioFacturacion getServicioFacturacionPort() {
        return super.getPort(new QName("https://siat.impuestos.gob.bo/ServicioFacturacionNotaCreditoDebito", "ServicioFacturacionPort"), ServicioFacturacion.class);
    }
    ...
    public ServicioFacturacion getServicioFacturacionPort(WebServiceFeature... features) {
        return super.getPort(new QName("https://siat.impuestos.gob.bo/ServicioFacturacionNotaCreditoDebito", "ServicioFacturacionPort"), ServicioFacturacion.class, features);
    }
