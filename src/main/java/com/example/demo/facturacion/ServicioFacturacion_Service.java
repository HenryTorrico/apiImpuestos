 ...
 * 
 */
@WebServiceClient(name = "ServicioFacturacion", targetNamespace = "https://siat.impuestos.gob.bo/ServicioFacturacionElectronica", wsdlLocation = "https://pilotosiatservicios.impuestos.gob.bo/v1/ServicioFacturacionElectronica?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://pilotosiatservicios.impuestos.gob.bo/v1/ServicioFacturacionElectronica?wsdl");
